      ...
      double precision, dimension(:), allocatable :: influx
     ...
     & allocatable :: avpvelinter3
      ...
      double precision :: radiusvalve
      
      !!!!!!!!!!!!!!!!!!!!!!!!!!
      ! trajectory parameters  !
      !!!!!!!!!!!!!!!!!!!!!!!!!!
      
      ! particle is out parameter
      integer :: parout
      ...
      ! decision if file is supposed to be appended
      integer :: fileappend
      ! the radius of the "outflow orifice"
      double precision :: radoutflow
